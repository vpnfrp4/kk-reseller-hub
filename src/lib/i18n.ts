...
export const t = {
  ...
  settings: {
    ...
    preferences: { mm: "စိတ်ကြိုက်ချိန်ညှိမှု", en: "Preferences" },
    security: { mm: "လုံခြုံရေး", en: "Security" },
    notifications: { mm: "အသိပေးချက်များ", en: "Notifications" },
    apiKeys: { mm: "API ကီးများ", en: "API Keys" },
    sessions: { mm: "လော့ဂ်အင်မှတ်တမ်း", en: "Sessions" },
    email: { mm: "အီးမေးလ်လိပ်စာ", en: "Email Address" },
    emailCannotChange: { mm: "အီးမေးလ် ပြောင်း၍မရပါ", en: "Email cannot be changed" },
    displayName: { mm: "ပြသမည့်အမည်", en: "Display Name" },
    enterName: { mm: "သင့်အမည်ထည့်ပါ", en: "Enter your name" },
    personalInfo: { mm: "ကိုယ်ရေးအချက်အလက်", en: "Personal Information" },
    personalInfoDesc: { mm: "ပြသမည့်အမည်နှင့် ပရိုဖိုင်ဓာတ်ပုံ ပြင်ဆင်ရန်", en: "Update your display name and avatar" },
    changeAvatar: { mm: "ပုံပြောင်းမည်", en: "Change Avatar" },
    uploadAvatar: { mm: "ပုံတင်မည်", en: "Upload Avatar" },
    removeAvatar: { mm: "ဖယ်ရှားမည်", en: "Remove" },
    saveChanges: { mm: "ပြောင်းလဲမှုသိမ်းမည်", en: "Save Changes" },
    telegramTitle: { mm: "Telegram Bot ချိတ်ဆက်မှု", en: "Telegram Bot Integration" },
    telegramDesc: { mm: "Telegram မှတစ်ဆင့် အမှာစာများ စီမံခန့်ခွဲပြီး အချိန်နှင့်တပြေးညီ အသိပေးချက်များ ရယူပါ", en: "Manage orders and receive real-time notifications via Telegram" },
    connected: { mm: "ချိတ်ဆက်ပြီး", en: "Connected" },
    notConnected: { mm: "ချိတ်ဆက်မထားပါ", en: "Not Connected" },
    autoNotifications: { mm: "အလိုအလျောက် အသိပေးချက်များ", en: "Auto Notifications" },
    botCommands: { mm: "Bot ညွှန်ကြားချက်များ", en: "Bot Commands" },
    disconnectTelegram: { mm: "Telegram ဖြုတ်မည်", en: "Disconnect Telegram" },
    whyConnect: { mm: "Telegram ဘာကြောင့်ချိတ်ဆက်သင့်သလဲ?", en: "Why Connect Telegram?" },
    generateLink: { mm: "ချိတ်ဆက်လင့် ထုတ်မည်", en: "Generate Connection Link" },
    linkExpireNote: { mm: "ဤလင့်သည် အသစ်ထုတ်သည့်အခါ ပျက်ပါမည်။ အခြားသူများနှင့် မျှဝေမပါနှင့်။", en: "This link expires when you generate a new one. Don't share it with others." },
    orderPlaced: { mm: "အမှာစာတင်ပြီး", en: "Order placed" },
    orderProcessing: { mm: "ဆောင်ရွက်နေသည်", en: "Order processing" },
    orderCompleted: { mm: "ပြီးမြောက်ပြီး", en: "Order completed" },
    orderRejected: { mm: "ငြင်းပယ်ခံရသည်", en: "Order rejected" },
    topupApproved: { mm: "ငွေဖြည့်အတည်ပြုပြီး", en: "Top-up approved" },
    balanceAlerts: { mm: "လက်ကျန်ငွေ သတိပေးချက်", en: "Balance alerts" },
    instantNotifs: { mm: "အမှာစာ အခြေအနေ ချက်ချင်းအသိပေးချက်", en: "Instant order status notifications" },
    topupAlerts: { mm: "ငွေဖြည့်မှု သတိပေးချက်နှင့် လက်ကျန်ငွေအသစ်", en: "Wallet top-up alerts with new balance" },
    checkFromTg: { mm: "Telegram မှ အမှာစာ အခြေအနေ စစ်ဆေးရန်", en: "Check order status directly from Telegram" },
    quickBalance: { mm: "အက်ပ်မဖွင့်ဘဲ လက်ကျန်ငွေ အမြန်စစ်ဆေးရန်", en: "Quick balance checks without opening the app" },
    step1: { mm: "အောက်ပါ \"ချိတ်ဆက်လင့် ထုတ်မည်\" ကို နှိပ်ပါ။", en: "Click \"Generate Link\" below to create your unique connection link." },
    step2: { mm: "လင့်ကို ဖွင့်ပြီး Telegram တွင် @{bot} ကို စတင်ပါ။", en: "Open the link to start @{bot} on Telegram." },
    step3: { mm: "သင့်အကောင့် အလိုအလျောက် ချိတ်ဆက်ပါလိမ့်မည်!", en: "Your account will be automatically linked!" },
