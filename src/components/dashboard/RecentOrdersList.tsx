  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-12 rounded-card border border-border/40 bg-card">
        ...
        <div className="space-y-2">
          {orders.slice(0, 8).map((order: any) => (
            <button
              ...
              className={cn(
                "w-full text-left rounded-card border border-border/40 bg-card p-3.5 lg:p-4",
                "active:scale-[0.99] transition-all duration-150",
                "hover:border-primary/20 hover:shadow-sm group"
              )}
            >
