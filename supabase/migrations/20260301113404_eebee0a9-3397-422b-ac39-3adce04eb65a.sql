...
CREATE OR REPLACE FUNCTION public.process_purchase(
  ...
  p_service_margin numeric DEFAULT NULL
)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  ...
  IF v_ptype = 'api' AND v_product.api_rate IS NOT NULL THEN
    ...
    -- Margin hierarchy: service (passed param) > product > category > global
    IF p_service_margin IS NOT NULL AND p_service_margin > 0 THEN
      v_margin := p_service_margin;
    ELSE
